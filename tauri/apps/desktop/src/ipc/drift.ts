...
import type { DriftFilterInput, DriftReport } from "@springtale/ui/dashboard/types";
...
export async function getRuleDrift(filter: DriftFilterInput): Promise<DriftReport> {
