...
| Cooperation framework status | — | Fully extracted into `crates/springtale-cooperation/` (42 pub modules) as of April 2026 and wired through a 25-step formation tick. Remaining work is ergonomic only — see `docs/arch/AUDIT-NOTES.md §3` and `docs/intended-arch/COOPERATION_IMPLEMENTATION_PLAN.md`. |
