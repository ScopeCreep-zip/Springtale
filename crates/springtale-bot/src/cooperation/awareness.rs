...
use super::cadence::{AgentId, TickReport};
use super::formation::{AgentHealth, DynamicRole};
use super::momentum::MomentumTier;
...
mod tests {
    ...
    fn make_snapshot(id: AgentId, health: AgentHealth) -> NeighborSnapshot {
        NeighborSnapshot {
            agent_id: id,
            health,
            current_role: DynamicRole::Unassigned,
    ...
    fn test_interference_detection() {
        ...
        let report = TickReport {
            agent_id: other_id,
            tick_sequence: 1,
            action_taken: Some("write".to_owned()),
