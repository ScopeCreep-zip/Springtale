...
use crate::types::{FuelAmount, ResourceId};
...
pub enum SacrificeType {
    ...
    Expendable {
        sacrificer: AgentId,
        expected_recovery: Option<crate::recovery::RecoveryAction>,
...
pub struct SacrificeCost {
    pub fuel_cost: FuelAmount,
    pub capability_reduction: Vec<CapabilityDecl>, // capabilities temporarily lost
...
mod tests {
    ...
    fn test_sacrifice_types() {
        ...
        let covering = SacrificeType::Covering {
            sacrificer: a,
            beneficiary: b,
            cost_to_sacrificer: SacrificeCost {
                fuel_cost: FuelAmount(100),
        ...
        let expendable = SacrificeType::Expendable {
            sacrificer: a,
            expected_recovery: Some(crate::recovery::RecoveryAction::Redeployment {
                dead_agent: a,
                replacement_capabilities: vec!["basic".into()],
                cost: crate::recovery::RecoveryCost::Free,
                degraded: true,
            }),
